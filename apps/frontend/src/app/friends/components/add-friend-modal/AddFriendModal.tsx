...
export function AddFriendModal({ open, onClose }: Props) {
  ...
  const showDropdown = dropdownOpen && canSearch && (search.isFetching || search.isFetched);
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <button
            ...
            onClick={onClose}
            aria-label={t("Close invite friends modal", {
              $id: "friends.addModal.closeAria",
            })}
          >
            <X size={16} />
          </button>
          ...
          <Heading>{t("Invite friends", { $id: "friends.addModal.title" })}</Heading>
        ...
        <div className={styles.searchRow}>
          <div className={styles.usernameInput} ref={inputWrapperRef}>
            <input
              ...
              onFocus={() => setDropdownOpen(hasReachedSearchThreshold(username))}
            />
          </div>
