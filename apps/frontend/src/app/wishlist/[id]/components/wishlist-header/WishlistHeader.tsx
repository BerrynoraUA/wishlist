...
export function WishlistHeader({
  ...
  const showMenu = Boolean(onEdit || onDelete || onManageAccess);
        ...
        <div className={styles.bannerInner}>
          <div
            className={`${styles.heroLayout} ${
              canAddItem || showAsideActions ? styles.hasActions : ""
            }`.trim()}
          >
            <button
              type="button"
                ...
                <div className={`${styles.badges} ${isOwner ? styles.ownerBadges : ""}`.trim()}>
                  <div className={styles.badgeWrapper} ref={visibilityPopoverRef}>
                    <span
                      ...
                      onClick={canInlineEdit ? () => setEditingVisibility((v) => !v) : undefined}
                    >
                          ...
                          [
                            {
                              ...
                              icon: Globe,
                              label: visibilityLabels[WishlistVisibility.Public],
                            },
                            {
                              value: WishlistVisibility.FriendsOnly,
                              icon: Users,
                              label: visibilityLabels[WishlistVisibility.FriendsOnly],
                            },
                            {
                              value: WishlistVisibility.Private,
                              icon: Lock,
                              label: visibilityLabels[WishlistVisibility.Private],
                            },
                          ] as const
                        ).map((opt) => (
                          <button
                  ...
                  <div className={styles.badgeWrapper} ref={datePopoverRef}>
                    {eventDate ? (
                      <span
                        ...
                        onClick={canInlineEdit ? () => setEditingDate((v) => !v) : undefined}
                      >
              ...
              <div className={styles.heroAside}>
                <div className={styles.rail}>
                  ...
                  {showAsideShare && (
                    <button
                      type="button"
                      className={`${styles.menuButton} ${styles.railAction} iconTooltipTrigger`}
                      onClick={onShare}
                      data-guide-target="wishlist-share"
                      aria-label={t("Share wishlist", {
                        $id: "wishlist.header.shareAria",
                    ...
                    >
                      ...
                      <span className={styles.railActionLabel}>
                        {t("Share", { $id: "wishlist.header.shareLabel" })}
                      </span>
                    </button>
                  )}
                </div>
