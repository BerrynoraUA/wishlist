...
function AlertTitle({ className, ...props }: React.ComponentProps<typeof Text>) {
  return (
    <Text
      className={cn("mb-1 ms-0.5 min-h-4 ps-6 font-medium leading-none tracking-tight", className)}
      {...props}
    />
  );
}
...
function AlertDescription({ className, ...props }: React.ComponentProps<typeof Text>) {
  ...
  return (
    <Text
      className={cn(
        "text-muted-foreground ms-0.5 pb-1.5 ps-6 text-sm leading-relaxed",
