-- ============================================================
-- Item Priorities refactor
-- Replaces item.priority (smallint) with FK to item_priorities
...
-- 2. Add priority_id column to item
ALTER TABLE "public"."item" ADD COLUMN IF NOT EXISTS "priority_id" uuid REFERENCES "public"."item_priorities"("id") ON DELETE SET NULL;

-- 3. Migrate existing priority smallint values to UUIDs
UPDATE "public"."item" SET "priority_id" = '11111111-0000-0000-0000-000000000001' WHERE "priority" = 1;
UPDATE "public"."item" SET "priority_id" = '11111111-0000-0000-0000-000000000002' WHERE "priority" = 2;
UPDATE "public"."item" SET "priority_id" = '11111111-0000-0000-0000-000000000003' WHERE "priority" = 3;

-- 4. Drop old priority column
ALTER TABLE "public"."item" DROP COLUMN IF EXISTS "priority";

-- 5. Add selected_priorities to user_settings
ALTER TABLE "public"."user_settings"
  ADD COLUMN IF NOT EXISTS "selected_priorities" uuid[]
...
-- ============================================================
-- 6. Replace get_wishlist_items — now returns TABLE with priority_name
-- ============================================================
...
-- ============================================================
-- 7. Replace get_wishlist_items_by_share_token — same shape
-- ============================================================
...
-- ============================================================
-- 8. get_friends_wishlists_discover — update priority in jsonb + p_priorities type
-- ============================================================
...
-- ============================================================
-- 9. toggle_item_reservation_for_current_user — update priority in jsonb return
-- ============================================================
...
-- ============================================================
-- 10. toggle_item_bought_for_current_user — update priority in jsonb return
-- ============================================================
...
-- ============================================================
-- 11. get_reserved_wishlists_by_me — update priority in jsonb (no p_priorities param)
-- ============================================================
...
-- ============================================================
-- 12. get_friends_wishlists_discover_all — update priority in jsonb + p_priorities type
-- ============================================================
...
-- ============================================================
-- 13. get_reserved_items_by_me — update p_priorities to uuid[], priority_name text
-- ============================================================
...
returns table(item_id uuid, title text, price numeric, discount_price numeric, currency text, url text, store text, image text, priority_name text, status integer, wishlist_id uuid, wishlist_title text, owner_id uuid, owner_name text, owner_username text, owner_avatar text)
language plpgsql
security definer
set search_path = public
as $function$
...
-- ============================================================
-- 14. get_my_bought_items — update p_priorities to uuid[], priority_name text
-- ============================================================
...
returns table(item_id uuid, title text, price numeric, discount_price numeric, url text, store text, image text, priority_name text, status integer, wishlist_id uuid, wishlist_title text, owner_id uuid, owner_name text, owner_username text, owner_avatar text)
language plpgsql
security definer
set search_path = public
as $function$
...
-- ============================================================
-- 15. get_user_visible_items_by_max_price � replace i.priority with priority_id + priority_name
-- ============================================================
